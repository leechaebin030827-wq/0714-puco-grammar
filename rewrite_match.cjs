...
const replacement = `  function matchLocalScenario(inputText) {
...
const startIndex = content.indexOf('  function matchLocalScenario(inputText) {');
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log('Successfully replaced matchLocalScenario text.');
} else {
